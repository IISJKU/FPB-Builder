        ...
        function (a, b, c) {
          ...
          function u(a, b) {
            ...
            if (
              (d &&
                (a.version !== b &&
                  console.warn('The database "' + a.name + "\" can't be downgraded from version " + a.db.version + " to version " + a.version + "."),
                      ...
                      : i.db.transaction(
                          function (c) {
                            T(
                              c,
                              i,
                              "INSERT OR REPLACE INTO " + i.storeName + " (key, value) VALUES (?, ?)",
                              [a, b],
                              function () {
                                f(h);
                              },
          ...
          function ca(a, b) {
            ...
            return (
              (d = a.name
                ? new va(function (b) {
                    var d;
                    (d = a.name === c.name ? e._dbInfo.db : openDatabase(a.name, "", "", 0)), b(a.storeName ? { db: d, storeNames: [a.storeName] } : ba(d));
                  }).then(function (a) {
                    return new va(function (b, c) {
                      a.db.transaction(
                        function (d) {
          ...
          var va = Promise,
            ...
            fb = { description: "", driver: cb.slice(), name: "localforage", size: 4980736, storeName: "keyvaluepairs", version: 1 },
            gb = (function () {
              function a(b) {
                d(this, a);
                for (var c in bb)
