...
//this will be the function called by the front end!
//
// TODO TOMORROW!!!
//
ipcMain.on("generateEpubs", () => {
  //loads data from session storage, that was written into the front end!
  MetadataManager.fetchDataFromFrontend();
  MetadataManager.validateMetadata();

  PageManager.fetchDataFromFrontend();
  PageManager.validateMetadata();
